...
@Mod("inzo")
public class InzoMod {
	public static final Logger LOGGER = LogManager.getLogger(InzoMod.class);
	public static final String MODID = "inzo";

	public InzoMod() {
		MinecraftForge.EVENT_BUS.register(this);
		IEventBus bus = FMLJavaModLoadingContext.get().getModEventBus();
		InzoModSounds.REGISTRY.register(bus);
